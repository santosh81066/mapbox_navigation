...
import 'package:nine_cabs_pqrtner/second_method.dart';

//import 'package:flutter_mapbox_navigation/flutter_mapbox_navigation.dart';

void main() => runApp(const MaterialApp(home: SecondNavigation()));
...
class _MyAppState extends State<MyApp> {
  ...
  final _stop2 =
      WayPoint(name: "Way Point 3", latitude: 17.443045, longitude: 78.378536);
  ...
  Future<void> initialize() async {
    ...
    platformVersion = await _directions.platformVersion.catchError((error) {
